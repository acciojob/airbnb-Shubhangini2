...
public class HotelManagementController {
    ...
    public String addHotel(@RequestBody Hotel hotel){
        ...
        if(hotelManagementService.addHotel(hotel)){
            return "SUCCESS";
        }
        return "FAILURE";
    }
    ...
    public String getHotelWithMostFacilities(@PathVariable String hotelName){ //pathVariable not given
    ...
    public int bookARoom(@RequestBody Booking booking){
        ...
        hotelManagementService.addBooking(booking);
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
       ...
       int bookings = hotelManagementService.findBookingsByPerson(aadharCard);
        return 0;
    }
    ...
    public Hotel updateFacilities(List<Facility> newFacilities,String hotelName){
        ...
        hotelManagementService.createNewFacilities(newFacilities,hotelName);
        return null;
    }
